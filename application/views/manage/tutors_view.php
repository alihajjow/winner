<?php $this->load->view('common/header1') ?>		<link href="<?php echo base_url() ?>assetss/plugins/datatables/jquery.dataTables.min.css" rel="stylesheet" type="text/css" />        <link href="<?php echo base_url() ?>assetss/plugins/datatables/buttons.bootstrap.min.css" rel="stylesheet" type="text/css" />        <link href="<?php echo base_url() ?>assetss/plugins/datatables/fixedHeader.bootstrap.min.css" rel="stylesheet" type="text/css" />        <link href="<?php echo base_url() ?>assetss/plugins/datatables/responsive.bootstrap.min.css" rel="stylesheet" type="text/css" />        <link href="<?php echo base_url() ?>assetss/plugins/datatables/scroller.bootstrap.min.css" rel="stylesheet" type="text/css" /><div class="widget">	<div class="widget-head">			<div class="col-sm-12">                        <div class="card-box">		<h4 class="header-title m-t-0 m-b-30"  <?php echo LANG() == 'en' ? '' : 'style="text-align: right"' ?>><?php echo $title; ?></h4>     		<!-- Widget --><div class="widget">	<form onsubmit="default" action="" method="post" role="form">	<div class="widget-body overflow-x">		<div class="row">			<!-- Table -->		<table id="datatable" class="table table-striped table-bordered" <?php echo LANG() == 'en' ? '' : 'style="direction: rtl"' ?>>
			...
			<thead class="bg-gray">
				<tr>
					...
					<td class="center"><?php translate('tutor_name') ?></td>
					<td class="center"><?php translate('catigory') ?></td>
					<td class="center"><?php translate('img') ?></td>					
					<td class="center"><?php translate('edit_data') ?></td>
					<td class="center"><?php translate('fire') ?></td>
					<td class="center"><?php translate('active') ?></td>
					
				</tr>
			</thead>
			<tbody>								
              <?php $i = 1; foreach ($tutors->result() as $result) { ?>
				<tr>
					<td class="center uniformjs"><?php echo $i; ?></td>
					<td class="center"><?php echo $result->tutor_name; ?></td>
					<td class="center"><?php echo $result->cat_name; ?></td>
					<td class="center">
					<div class="btn-group btn-group-xs">
					<a href="<?php echo base_url()."../site/uploads/tutors/".$result->img ?>" class="btn btn-default"><i class="fa fa-eye"></i></a>
					</div>
					</div>
					</div></td>			  
		            <td class="center"><div class="btn-group btn-group-xs"><a href="<?php echo base_url(). "edit_tutor/$result->tutor_id" ?>" ><span class="label label-primary"><i class="ti-pencil"></i></span></a></div></td>
					<td class="center"><div class="btn-group btn-group-xs"><a onclick="return confirm('are you sure?')" href="<?php echo base_url(). "del_tutor/$result->tutor_id" ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></div></td>
			...
			<div class="col-md-12">
				<div class="form-group" style="margin-top: 20px">
					<a href="<?php base_url() ?>tutors" class="btn btn-primary"><?php translate('add') ?></a>
...
<script type="text/javascript">
	...
	function activate (id) {
	    $.ajax({
	        url: '<?php echo base_url(); ?>active_tutor/' + id,
