...
<form onsubmit="default" action="<?php echo base_url()."add_role"; ?>" method="post" role="form">
<div class="widget">
	...
	<div class="widget-body">
		<div class="row" <?php echo LANG() == 'en' ? '' : 'style="text-align: right"' ?>>	
			<div class="form-group <?php echo form_error('role_name') ? 'has-error' : ''; ?>">
				...
				<input name="role_name" value="<?php echo set_value('role_name'); ?>" type="text" id="inputTitle" class="col-md-6 form-control" placeholder="" <?php echo LANG() == 'en' ? '' : 'style="text-align: right"' ?>>
			...
			<div class="form-group <?php echo form_error('role_desc') ? 'has-error' : ''; ?>">
				...
				<input name="role_desc" value="<?php echo set_value('role_desc'); ?>" type="text" id="inputTitle" class="col-md-6 form-control" placeholder="" <?php echo LANG() == 'en' ? '' : 'style="text-align: right"' ?>>
				<div class="separator"></div>
			</div>
