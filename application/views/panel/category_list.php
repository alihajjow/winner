		...
		<table id="datatable" class="table table-striped table-bordered" <?php echo LANG() == 'en' ? '' : 'style="direction: rtl"' ?>>		
			...
			<thead class="bg-gray">
				<tr>
					...
					<td class="center"><?php translate('cat_name') ?></td>
					<td class="center"><?php translate('cat_cor') ?></td>
			...
			<tbody>								
              <?php $i = 1; foreach ($results as $result) { ?>
				<tr>
				   ...
				   <td class="center"><a href="<?php echo base_url() .'courses/' . $result->cat_id ?>"> <span class="label label-primary"><i class="ti-pencil-alt"></i></span></a></td>   

			        <td class="center"><a href="<?php echo base_url() .'courses/' . $result->cat_id ?>"> <span class="label label-primary"><i class=" ti-pencil "></span></a></td>   
			        <td><div class="checkbox>
						
							<div class="checkbox checkbox-primary">
                                        <input  type="checkbox" id="checkbox2"<?php echo $result->active == "1" ? 'checked': ''; ?>  onchange="activate(<?php echo $result->cat_id; ?>)" >
			...
			<div class="col-md-12">
				<div class="form-group" style="margin-top: 20px">
					<a href="<?php echo base_url(); ?>add_course_cat" class="btn btn-primary"><?php translate('new_course_cat') ?></a>
...
<script type="text/javascript">
	...
	function activate (id) {
	    $.ajax({
	        url: '<?php echo base_url(); ?>activate/' + id,
