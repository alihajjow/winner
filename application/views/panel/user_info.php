...
<div class="widget">
	<div class="widget-head">
		<h4 class="heading" <?php echo LANG() == 'en' ? '' : 'style="float: right"' ?>></h4>
	</div>
		...
		<div class="row">
			...
			<div class="col-md-6" <?php echo LANG() == 'en' ? '' : 'style="float: right; text-align: right"' ?>>
				<div class="form-group <?php echo form_error('first_name') ? 'has-error' : ''; ?>">
					...
					<input name="first_name" value="<?php echo $result->f_name; ?>" type="text" id="inputTitle" class="col-md-6 form-control"  placeholder="" <?php echo LANG() == 'en' ? '' : 'style="text-align: right"' ?>>
					<div class="separator"></div>
				</div>
			
				<div class="form-group  <?php echo form_error('last_name') ? 'has-error' : ''; ?>">
					<label for="inputTitle"><?php echo form_error('last_name') ? form_error('last_name') : translate('last_name') ?></label>
					<input name="last_name" value="<?php echo $result->l_name; ?>" type="text" id="inputTitle" class="col-md-6 form-control"  placeholder="" <?php echo LANG() == 'en' ? '' : 'style="text-align: right"' ?>>
					<div class="separator"></div>
				</div>
				...
				<div class="form-group <?php echo form_error('father_name') ? 'has-error' : ''; ?>">
					...
					<input name="father_name" value="<?php echo $result->father_name; ?>" type="text" id="inputTitle" class="col-md-6 form-control"  placeholder="" <?php echo LANG() == 'en' ? '' : 'style="text-align: right"' ?>>
					<div class="separator"></div>
				</div>
				...
				<div class="form-group <?php echo form_error('mother_name') ? 'has-error' : ''; ?>">
					...
					<input name="mother_name" value="<?php echo $result->mother_name; ?>" type="text" id="inputTitle" class="col-md-6 form-control"  placeholder="" <?php echo LANG() == 'en' ? '' : 'style="text-align: right"' ?>>
					<div class="separator"></div>
				</div>
				
				<div class="form-group <?php echo form_error('username') ? 'has-error' : ''; ?>">
					<label for="inputTitle"><?php echo form_error('username') ? form_error('username') : translate('username') ?></label>
					<input name="username" readonly value="<?php echo $result->username; ?>" type="text" id="inputTitle" class="col-md-6 form-control"  placeholder="" <?php echo LANG() == 'en' ? '' : 'style="text-align: right"' ?>>
					<div class="separator"></div>
				</div>
				
				<div class="form-group <?php echo form_error('password') ? 'has-error' : ''; ?>">
					<label for="inputTitle"><?php echo form_error('password') ? form_error('password') : translate('password') ?></label>
					<input name="password" readonly value="*******" type="text" id="inputTitle" class="col-md-6 form-control"  placeholder="" <?php echo LANG() == 'en' ? '' : 'style="text-align: right"' ?>>
					<div class="separator"></div>
				</div>
				...
				<div class="form-group <?php echo form_error('gov_id') ? 'has-error' : ''; ?>">
					<label for="inputTitle"><?php echo form_error('gov_id') ? form_error('gov_id') : translate('gov_id') ?></label>
					  <input name="gov_id" value="<?php echo $result->gov_id; ?>" type="text" id="inputTitle" class="col-md-6 form-control"  placeholder="" <?php echo LANG() == 'en' ? '' : 'style="text-align: right"' ?>>
					<div class="separator"></div>
				</div>
			</div>
			<div class="col-md-6" <?php echo LANG() == 'en' ? '' : 'style="float: right; text-align: right"' ?>>
				<div class="form-group <?php echo form_error('birth_place') ? 'has-error' : ''; ?>">
					...
					<input name="birth_place" value="<?php echo $result->birth_place; ?>" type="text" id="inputTitle" class="col-md-6 form-control"  placeholder="" <?php echo LANG() == 'en' ? '' : 'style="text-align: right"' ?>>
					<div class="separator"></div>
				</div>
				...
				<div class="form-group <?php echo form_error('birth_date') ? 'has-error' : ''; ?>" style="margin-bottom: 0">
					...
					<div class="input-group date" id="datepicker3">
					    <input class="form-control" type="text" name="birth_date" value="<?php echo $result->birth_date; ?>">
				...
				<div class="form-group <?php echo form_error('civil_reg') ? 'has-error' : ''; ?>">
					...
					<input name="civil_reg" value="<?php echo $result->civil_reg; ?>" type="text" id="inputTitle" class="col-md-6 form-control"  placeholder="" <?php echo LANG() == 'en' ? '' : 'style="text-align: right"' ?>>
					<div class="separator"></div>
				</div>
				...
				<div class="form-group <?php echo form_error('amaneh') ? 'has-error' : ''; ?>">
					...
					<input name="amaneh" value="<?php echo $result->amaneh; ?>" type="text" id="inputTitle" class="col-md-6 form-control"  placeholder="" <?php echo LANG() == 'en' ? '' : 'style="text-align: right"' ?>>
					<div class="separator"></div>
				</div>
				
				<div class="form-group <?php echo form_error('address') ? 'has-error' : ''; ?>">
					<label for="inputTitle"><?php echo form_error('address') ? form_error('address') : translate('address') ?></label>
					<input name="address" value="<?php echo $result->address; ?>" type="text" id="inputTitle" class="col-md-6 form-control"  placeholder="" <?php echo LANG() == 'en' ? '' : 'style="text-align: right"' ?>>
					<div class="separator"></div>
				</div>
				...
				<div class="form-group <?php echo form_error('mobile') ? 'has-error' : ''; ?>">
					...
					<input name="mobile" value="<?php echo $result->mobile; ?>" type="text" id="inputTitle" class="col-md-6 form-control"  placeholder="" <?php echo LANG() == 'en' ? '' : 'style="text-align: right"' ?>>
					<div class="separator"></div>
				</div>
				
				<div class="form-group <?php echo form_error('email') ? 'has-error' : ''; ?>">
					<label for="inputTitle"><?php echo form_error('email') ? form_error('email') : translate('email') ?></label>
					<input name="email" value="<?php echo $result->email; ?>" type="text" id="inputTitle" class="col-md-6 form-control"  placeholder="" <?php echo LANG() == 'en' ? '' : 'style="text-align: right"' ?>>
					<div class="separator"></div>
				</div>
