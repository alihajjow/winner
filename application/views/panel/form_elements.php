...
App.Scripts = {
	...
	plugins: [
		...
		'<?php echo base_url() ?>assets/plugins/core_ajaxify_davis/davis.min.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
		'<?php echo base_url() ?>assets/plugins/core_ajaxify_lazyjaxdavis/jquery.lazyjaxdavis.min.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
		'<?php echo base_url() ?>assets/plugins/core_preload/pace.min.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
		...
		'<?php echo base_url() ?>assets/plugins/ui_modals/bootbox.min.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
		'<?php echo base_url() ?>assets/plugins/notifications_gritter/js/jquery.gritter.min.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
		'<?php echo base_url() ?>assets/plugins/forms_editors_wysihtml5/js/wysihtml5-0.3.0_rc2.min.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
		'<?php echo base_url() ?>assets/plugins/forms_editors_wysihtml5/js/bootstrap-wysihtml5-0.0.2.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
		'<?php echo base_url() ?>assets/plugins/forms_wizards/jquery.bootstrap.wizard.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
		'<?php echo base_url() ?>assets/plugins/forms_elements_jasny-fileupload/js/bootstrap-fileupload.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
		...
		'<?php echo base_url() ?>assets/plugins/forms_elements_multiselect/js/jquery.multi-select.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
		'<?php echo base_url() ?>assets/plugins/forms_elements_inputmask/jquery.inputmask.bundle.min.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
		...
		'<?php echo base_url() ?>assets/plugins/forms_elements_colorpicker-farbtastic/js/farbtastic.min.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
	...
	bundle: [
		...
		'<?php echo base_url() ?>assets/components/forms_elements_bootstrap-switch/bootstrap-switch.init.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
		'<?php echo base_url() ?>assets/components/forms_elements_fuelux-checkbox/fuelux-checkbox.init.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
		'<?php echo base_url() ?>assets/components/ui_modals/modals.init.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
		'<?php echo base_url() ?>assets/components/admin_notifications_gritter/gritter.init.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
		'<?php echo base_url() ?>assets/components/forms_editors_wysihtml5/wysihtml5.init.js?v=v2.0.0-rc8', 
		'<?php echo base_url() ?>assets/components/forms_wizards/form-wizards.init.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
		'<?php echo base_url() ?>assets/components/forms_elements_fuelux-radio/fuelux-radio.init.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
		'<?php echo base_url() ?>assets/components/forms_elements_button-states/button-loading.init.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
		...
		'<?php echo base_url() ?>assets/components/forms_elements_multiselect/multiselect.init.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
		'<?php echo base_url() ?>assets/components/forms_elements_inputmask/inputmask.init.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
		...
		'<?php echo base_url() ?>assets/components/forms_elements_colorpicker-farbtastic/colorpicker-farbtastic.init.js?v=v2.0.0-rc8&sv=v0.0.1.2', 
...
<div id="sidebar-social-wrapper">
	...
	<ul class="menu list-unstyled">
					<li class="hasSubmenu">
								...
								<a href="#menu-f2e582de2ca605c8ab28c46ce34aba5b" data-toggle="collapse">
								...
								<ul class="collapse" id="menu-f2e582de2ca605c8ab28c46ce34aba5b">
								<li class="">

								<a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&layout_fixed=false" class="no-ajaxify">
						...
						<li class="">
								...
								<a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&layout_fixed=true" class="no-ajaxify">
						...
						<li class="hasSubmenu">
								...
								<a href="#menu-2f346d6902cb402bbe08568570ff3b49" data-toggle="collapse">
								...
								<ul class="collapse" id="menu-2f346d6902cb402bbe08568570ff3b49">
								<li class="">
						...
						<li class="hasSubmenu">
								...
								<a href="#menu-70577ef423befec73faebe83088e279d" data-toggle="collapse">
								...
								<ul class="collapse" id="menu-70577ef423befec73faebe83088e279d">
								<li class="">
						...
						<li class="hasSubmenu">
								...
								<a href="#menu-f721258c22dc4d51ffda492140e20f03" data-toggle="collapse">
								...
								<ul class="collapse" id="menu-f721258c22dc4d51ffda492140e20f03">
								<li class="">
						...
						<li class="hasSubmenu">
								...
								<a href="#menu-ef1fda37739a2d911f1c46e201416b26" data-toggle="collapse">
								...
								<ul class="collapse" id="menu-ef1fda37739a2d911f1c46e201416b26">
								<li class="">
	...
	<ul class="colors">
				<li class="active"><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=style-default" style="background-color: #25ad9f" class="no-ajaxify innerAll half"><span class="hide">style-default</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=green-army" style="background-color: #9FB478" class="no-ajaxify innerAll half"><span class="hide">green-army</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=alizarin-crimson" style="background-color: #F06F6F" class="no-ajaxify innerAll half"><span class="hide">alizarin-crimson</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=blue-gray" style="background-color: #5577b4" class="no-ajaxify innerAll half"><span class="hide">blue-gray</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=brown" style="background-color: #d39174" class="no-ajaxify innerAll half"><span class="hide">brown</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=purple-gray" style="background-color: #AF86B9" class="no-ajaxify innerAll half"><span class="hide">purple-gray</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=purple-wine" style="background-color: #CC6788" class="no-ajaxify innerAll half"><span class="hide">purple-wine</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=black-and-white" style="background-color: #979797" class="no-ajaxify innerAll half"><span class="hide">black-and-white</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=amazon" style="background-color: #8BC4B9" class="no-ajaxify innerAll half"><span class="hide">amazon</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=amber" style="background-color: #b0b069" class="no-ajaxify innerAll half"><span class="hide">amber</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=android-green" style="background-color: #A9C784" class="no-ajaxify innerAll half"><span class="hide">android-green</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=antique-brass" style="background-color: #B3998A" class="no-ajaxify innerAll half"><span class="hide">antique-brass</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=antique-bronze" style="background-color: #8D8D6E" class="no-ajaxify innerAll half"><span class="hide">antique-bronze</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=artichoke" style="background-color: #B0B69D" class="no-ajaxify innerAll half"><span class="hide">artichoke</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=atomic-tangerine" style="background-color: #F19B69" class="no-ajaxify innerAll half"><span class="hide">atomic-tangerine</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=bazaar" style="background-color: #98777B" class="no-ajaxify innerAll half"><span class="hide">bazaar</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=bistre-brown" style="background-color: #C3A961" class="no-ajaxify innerAll half"><span class="hide">bistre-brown</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=green" style="background-color: #77ac40" class="no-ajaxify innerAll half"><span class="hide">green</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=bittersweet" style="background-color: #d6725e" class="no-ajaxify innerAll half"><span class="hide">bittersweet</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=blueberry" style="background-color: #7789D1" class="no-ajaxify innerAll half"><span class="hide">blueberry</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=bud-green" style="background-color: #6fa362" class="no-ajaxify innerAll half"><span class="hide">bud-green</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=coral" style="background-color: #7eccc2" class="no-ajaxify innerAll half"><span class="hide">coral</span></a></li>
				<li><a href="?module=admin&page=form_elements&url_rewrite=&build=&v=v2.0.0-rc8&skin=burnt-sienna" style="background-color: #E4968A" class="no-ajaxify innerAll half"><span class="hide">burnt-sienna</span></a></li>
			</ul>
</div>
						...
						<li class="hasSubmenu active">
								...
								<a href="#menu-aaddef1b4a1cc4f535bb6b7a2ea92554" data-toggle="collapse">
								...
								<ul class="collapse in" id="menu-aaddef1b4a1cc4f535bb6b7a2ea92554">
								<li class="">
						...
						<li class="hasSubmenu">
								...
								<a href="#menu-5831c28c9c954d4da6e62f51f8a51b88" data-toggle="collapse">
								...
								<ul class="collapse" id="menu-5831c28c9c954d4da6e62f51f8a51b88">
								<li class="">
						...
						<li class="hasSubmenu active">
								...
								<a href="#menu-70abb9127131955f09b9725e23c7a056" data-toggle="collapse">
								...
								<ul class="collapse in" id="menu-70abb9127131955f09b9725e23c7a056">
								<li class="">
						...
						<li class="hasSubmenu">
								...
								<a href="#menu-083c13143723c7cdd5667a0ae2d52603" data-toggle="collapse">
								...
								<ul class="collapse" id="menu-083c13143723c7cdd5667a0ae2d52603">
								<li class="hasSubmenu">

								<a href="#menu-562a2719b2972ad0cdaa4fa79bf5c2c6" data-toggle="collapse">
								...
								<ul class="collapse" id="menu-562a2719b2972ad0cdaa4fa79bf5c2c6">
								<li class="">
						...
						<li class="hasSubmenu">
								...
								<a href="#menu-fa8bbc1079f8558a2a241824d7a188b2" data-toggle="collapse">
								...
								<ul class="collapse" id="menu-fa8bbc1079f8558a2a241824d7a188b2">
								<li class="">
						...
						<li class="hasSubmenu">
								...
								<a href="#menu-dd71096e5728aca18d4c10c1508f89ac" data-toggle="collapse">
								...
								<ul class="collapse" id="menu-dd71096e5728aca18d4c10c1508f89ac">
								<li class="">
						...
						<li class="hasSubmenu">
								...
								<a href="#menu-1f60848f0b5ce74b71230986ba4e9182" data-toggle="collapse">
								...
								<ul class="collapse" id="menu-1f60848f0b5ce74b71230986ba4e9182">
								<li class="">
						...
						<li class="hasSubmenu">
								...
								<a href="#menu-489a1fb4034e5eebf19eaae49c2d1054" data-toggle="collapse">
								...
								<ul class="collapse" id="menu-489a1fb4034e5eebf19eaae49c2d1054">
								<li class="">
						...
						<li class="hasSubmenu">
								...
								<a href="#menu-1be908bf9d1dfece711cb2e7349dd070" data-toggle="collapse">
								...
								<ul class="collapse" id="menu-1be908bf9d1dfece711cb2e7349dd070">
								<li class="">
						...
						<li class="hasSubmenu">
								...
								<a href="#menu-ae7d85f177b54086f7ac7ba90bc650ba" data-toggle="collapse">
								...
								<ul class="collapse" id="menu-ae7d85f177b54086f7ac7ba90bc650ba">
								<li class="">
						...
						<li class="hasSubmenu">
								...
								<a href="#menu-f61c62e3ecf5f16470329d94b06b7c8f" data-toggle="collapse">
								...
								<ul class="collapse" id="menu-f61c62e3ecf5f16470329d94b06b7c8f">
								<li class="">
						...
						<li class="hasSubmenu">
								...
								<a href="#menu-4f238a2216ae23acddece6f742f7b545" data-toggle="collapse">
								...
								<ul class="collapse" id="menu-4f238a2216ae23acddece6f742f7b545">
								<li class="">
						...
						<li class="hasSubmenu">
								...
								<a href="#menu-810c8406c6f0e1f33060de1165df1305" data-toggle="collapse">
								...
								<ul class="collapse" id="menu-810c8406c6f0e1f33060de1165df1305">
								<li class="">
				...
				<ul>
					...
					<li class="conversation innerAll">
						...
						<div class="media">
							...
							<div class="media-object pull-left"><img src="<?php echo base_url() ?>assets/images/people/50/1.jpg" alt="Image" class="img-circle" /></div>
							<div class="media-body">
								<blockquote>
						...
						<div class="media primary right">
							...
							<div class="media-object pull-right"><img src="<?php echo base_url() ?>assets/images/people/50/2.jpg" alt="Image" class="img-circle" /></div>
							<div class="media-body">
				...
				<div class="mixitup" id="mixitup-chat" data-show-default="mixit-chat-1" data-layout-mode="list" data-target-selector=".mix" data-filter-selector=".filter-chat">
					<ul>
						...
						<li>
								...
								<a href="#chat-conversation" data-toggle="tab" class="pull-left media-object"><img src="<?php echo base_url() ?>assets/images/people/35/1.jpg" class="img-circle" /></a>
								<div class="media-body">
									...
									<small>Hey, the party is on tonight!</small>
																					...
																					<div class="mixit-chat-1 mix media border-bottom innerAll margin-none">
								<a href="#chat-conversation" data-toggle="tab" class="pull-left media-object"><img src="<?php echo base_url() ?>assets/images/people/35/2.jpg" class="img-circle" /></a>
								<div class="media-body">
									<a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
										<i class="fa fa-comments"></i> 4
									</a>
									...
									<small>Hey, the party is on tonight!</small>
																					...
																					<div class="mixit-chat-1 mix media border-bottom innerAll margin-none">
								<a href="#chat-conversation" data-toggle="tab" class="pull-left media-object"><img src="<?php echo base_url() ?>assets/images/people/35/3.jpg" class="img-circle" /></a>
								<div class="media-body">
									<a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
										<i class="fa fa-comments"></i> 4
									</a>
									...
									<small>Hey, the party is on tonight!</small>
																					...
																					<div class="mixit-chat-1 mix media border-bottom innerAll margin-none">
								<a href="#chat-conversation" data-toggle="tab" class="pull-left media-object"><img src="<?php echo base_url() ?>assets/images/people/35/4.jpg" class="img-circle" /></a>
								<div class="media-body">
									<a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
										<i class="fa fa-comments"></i> 4
									</a>
									...
									<small>Hey, the party is on tonight!</small>
																					...
																					<div class="mixit-chat-1 mix media border-bottom innerAll margin-none">
								<a href="#chat-conversation" data-toggle="tab" class="pull-left media-object"><img src="<?php echo base_url() ?>assets/images/people/35/5.jpg" class="img-circle" /></a>
								<div class="media-body">
									<a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
										<i class="fa fa-comments"></i> 4
									</a>
								...
								<a href="#chat-conversation" data-toggle="tab" class="pull-left media-object"><img src="<?php echo base_url() ?>assets/images/people/35/6.jpg" class="img-circle" /></a>
								<div class="media-body">
									<a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
										<i class="fa fa-comments"></i> 4
									</a>
									...
									<small>Hey, the party is on tonight!</small>
																					...
																					<div class="mixit-chat-2 mix media border-bottom innerAll margin-none">
								<a href="#chat-conversation" data-toggle="tab" class="pull-left media-object"><img src="<?php echo base_url() ?>assets/images/people/35/7.jpg" class="img-circle" /></a>
								<div class="media-body">
									<a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
										<i class="fa fa-comments"></i> 4
									</a>
									...
									<small>Hey, the party is on tonight!</small>
																					...
																					<div class="mixit-chat-2 mix media border-bottom innerAll margin-none">
								<a href="#chat-conversation" data-toggle="tab" class="pull-left media-object"><img src="<?php echo base_url() ?>assets/images/people/35/8.jpg" class="img-circle" /></a>
								<div class="media-body">
									<a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
										<i class="fa fa-comments"></i> 4
									</a>
									...
									<small>Hey, the party is on tonight!</small>
																					...
																					<div class="mixit-chat-2 mix media border-bottom innerAll margin-none">
								<a href="#chat-conversation" data-toggle="tab" class="pull-left media-object"><img src="<?php echo base_url() ?>assets/images/people/35/9.jpg" class="img-circle" /></a>
								<div class="media-body">
									<a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
										<i class="fa fa-comments"></i> 4
									</a>
									...
									<small>Hey, the party is on tonight!</small>
																					...
																					<div class="mixit-chat-2 mix media border-bottom innerAll margin-none">
								<a href="#chat-conversation" data-toggle="tab" class="pull-left media-object"><img src="<?php echo base_url() ?>assets/images/people/35/10.jpg" class="img-circle" /></a>
								<div class="media-body">
									<a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
										<i class="fa fa-comments"></i> 4
									</a>
								...
								<a href="#chat-conversation" data-toggle="tab" class="pull-left media-object"><img src="<?php echo base_url() ?>assets/images/people/35/11.jpg" class="img-circle" /></a>
								<div class="media-body">
									<a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
										<i class="fa fa-comments"></i> 4
									</a>
									...
									<small>Hey, the party is on tonight!</small>
																					...
																					<div class="mixit-chat-3 mix media border-bottom innerAll margin-none">
								<a href="#chat-conversation" data-toggle="tab" class="pull-left media-object"><img src="<?php echo base_url() ?>assets/images/people/35/12.jpg" class="img-circle" /></a>
								<div class="media-body">
									<a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
										<i class="fa fa-comments"></i> 4
									</a>
									...
									<small>Hey, the party is on tonight!</small>
																					...
																					<div class="mixit-chat-3 mix media border-bottom innerAll margin-none">
								<a href="#chat-conversation" data-toggle="tab" class="pull-left media-object"><img src="<?php echo base_url() ?>assets/images/people/35/13.jpg" class="img-circle" /></a>
								<div class="media-body">
									<a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
										<i class="fa fa-comments"></i> 4
									</a>
									...
									<small>Hey, the party is on tonight!</small>
																					...
																					<div class="mixit-chat-3 mix media border-bottom innerAll margin-none">
								<a href="#chat-conversation" data-toggle="tab" class="pull-left media-object"><img src="<?php echo base_url() ?>assets/images/people/35/14.jpg" class="img-circle" /></a>
								<div class="media-body">
									<a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
										<i class="fa fa-comments"></i> 4
									</a>
									...
									<small>Hey, the party is on tonight!</small>
																					...
																					<div class="mixit-chat-3 mix media border-bottom innerAll margin-none">
								<a href="#chat-conversation" data-toggle="tab" class="pull-left media-object"><img src="<?php echo base_url() ?>assets/images/people/35/15.jpg" class="img-circle" /></a>
								<div class="media-body">
									<a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
										<i class="fa fa-comments"></i> 4
									</a>
								...
								<a href="#chat-conversation" data-toggle="tab" class="pull-left media-object"><img src="<?php echo base_url() ?>assets/images/people/35/16.jpg" class="img-circle" /></a>
								<div class="media-body">
									<a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
										<i class="fa fa-comments"></i> 4
									</a>
	...
	<ul class="notifications pull-left hidden-xs">
		<li class="dropdown notif">
			...
			<ul class="dropdown-menu chat media-list">
				<li class="media">
			        <a class="pull-left" href="#"><img class="media-object thumb" src="<?php echo base_url() ?>assets/images/people/100/15.jpg" alt="50x50" width="50"/></a>
					<div class="media-body">
		      	...
		      	<li class="media">
		          	<a class="pull-left" href="#"><img class="media-object thumb" src="<?php echo base_url() ?>assets/images/people/100/16.jpg" alt="50x50" width="50"/></a>
					<div class="media-body">
			    ...
			    <li class="media">
		          	<a class="pull-left" href="#"><img class="media-object thumb" src="<?php echo base_url() ?>assets/images/people/100/17.jpg" alt="50x50" width="50"/></a>
			      	<div class="media-body">
...
<div class="innerLR">
	...
	<div class="widget widget-heading-simple widget-body-gray">
		<div class="widget-body">
			<p>There are various form elements contained in Social Admin Template, custom select controls, custom checkbox &amp; radio controls, custom input controls with &amp; without appended / prepended elements (icons, dropdowns, dropups, groups), toggle (on/off) buttons, icons &amp; many more.</p>
		</div>
	</div>
	<!-- // Widget END -->
	...
	<div class="widget widget-heading-simple widget-body-white">
		...
		<div class="widget-body center">
			...
			<div class="make-switch" data-on="primary" data-off="default"><input type="checkbox" checked></div>


			<div class="make-switch" data-on="warning" data-off="default"><input type="checkbox" checked></div>


			<div class="make-switch" data-on="danger" data-off="default"><input type="checkbox" checked></div>


			<div class="make-switch" data-on="success" data-off="default"><input type="checkbox" checked></div>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="widget widget-heading-simple widget-body-white" >
				...
				<div class="widget-body">
					<div class="innerB"><input type="text" placeholder="Text input" class="form-control" />
</div>
					<div class="innerB"><input type="text" placeholder="Text input" class="form-control" />
</div>
					<div class="innerB"><input type="text" placeholder="Large Input" class="form-control input-lg" />
</div>
					<div class="innerB"><input type="text" placeholder="Disabled Input" class="form-control " disabled />
</div>
					<div class="innerB"><input type="text" class="form-control" placeholder="Help Block below Input">
<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>
</div>
					<div class="innerB"><div class="row">
  <div class="col-xs-3">
  ...
  <div class="col-xs-5">
    <input type="text" class="form-control" placeholder="col 5">
					...
					<div class="innerB"><input class="form-control" id="focusedInput" type="text" value="This is focused...">
</div>
				</div>
			</div>
			<!-- // Widget END -->
			...
			<div class="widget widget-heading-simple widget-body-gray">
				...
				<div class="widget-body"><div class="input-group">
	<span class="input-group-addon">@</span>
	<input id="prependedInput" class="form-control col-md-12" type="text" placeholder="Username" />
</div>
</div>
			...
			<div class="widget widget-heading-simple widget-body-white">
				...
				<div class="widget-body"><div class="input-group">
			<span class="input-group-addon">$</span>
			<input class="form-control col-md-10" id="appendedPrependedInput" type="text" placeholder="100,000,000" /> 
	...
	<div class="widget-body innerAll inner-2x">
		...
		<div class="checkbox">
			<label class="checkbox-custom">
				...
				<i class="fa fa-fw fa-square-o"></i> Sexy checkbox
			</label> 
		</div> 
		<div class="checkbox"> 
			<label class="checkbox-custom"> 
				<input type="checkbox" name="checkbox" disabled="disabled"> 
				<i class="fa fa-fw fa-square-o disabled"></i> Checkbox disabled 
			</label> 
		</div> 
		<div class="checkbox"> 
			<label class="checkbox-custom"> 
				<input type="checkbox" name="checkbox" checked="checked" disabled="disabled"> 
				<i class="fa fa-fw fa-square-o checked disabled"></i> Checked and disabled 
			</label> 
		</div>
	</div>
</div>
<!-- // Widget END -->
		...
		<div class="col-md-6">
			...
			<div class="widget widget-heading-simple widget-body-white">
				...
				<!-- Widget heading -->
				<div class="widget-head">
					<h4 class="heading">Horizontal Form</h4>
				</div>
				<!-- // Widget heading END -->
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
			...
			<!-- Widget -->
				...
				<!-- Widget heading -->
				<div class="widget-head">
					<h4 class="heading">Form in Modals</h4>
				</div>
				<!-- // Widget heading END -->
...
<!-- // Modal END -->
					...
					<!-- Form Modal 2 -->
<a href="#modal-2" data-toggle="modal" class="btn btn-info"><i class="fa fa-fw fa-magic"></i> Modal Wizard Example 1</a>
								...
								<div class="tab-pane active" id="tab1-2">
									<div class="row">
										...
										<div class="col-md-9">
											...
											<input type="text" id="inputTitle" class="col-md-6 form-control" value="" placeholder="Enter product title ..." />
...
<!-- // Modal END -->
			...
			<div class="widget widget-heading-simple widget-body-white">
				...
				<div class="widget-body"><div class="input-group">
  	<input class="form-control" id="appendedInputButtons" type="text" placeholder="Placeholder .." />
  	<div class="input-group-btn"><button class="btn btn-default rounded-none" type="button"><i class="fa fa-search"></i></button></div>
  	<div class="input-group-btn"><button class="btn btn-default" type="button">Options</button></div>
</div>
</div>
	...
	<div class="input-group-btn btn-group dropup">
		<button class="btn btn-default rounded-none" tabindex="-1">Action</button>
	</div>
	<div class="input-group-btn">
	...
	<div class="widget-body innerAll inner-2x">
		<div class="radio">
			<label class="radio-custom">
				...
				<i class="fa fa-circle-o checked"></i> Checked Radio
			</label> 
		</div> 
		<div class="radio"> 
			<label class="radio-custom"> 
				<input type="radio" name="radio"> 
				<i class="fa fa-circle-o"></i> Custom Radio
			</label> 
		</div> 
		<div class="radio"> 
			<label class="radio-custom"> 
				<input type="radio" name="radio" disabled="disabled"> 
				<i class="fa fa-circle-o disabled"></i> Disabled Radio
			</label> 
		</div> 
		<div class="radio"> 
			<label class="radio-custom"> 
				<input type="radio" checked="checked" disabled="disabled"> 
				<i class="fa fa-circle-o checked disabled"></i> Checked and disabled
			</label> 
		</div>
	</div>
</div>
<!-- // Widget END -->
	...
	<div class="widget widget-heading-simple widget-body-white">
		...
		<div class="widget-body">
			<div class="row">
				<div class="col-md-6"><h4 class="separator bottom">File upload widget</h4>
<div class="fileupload fileupload-new margin-none" data-provides="fileupload">
  	<div class="input-group">
    	...
    	<span class="input-group-btn">
    		<span class="btn btn-default btn-file"><span class="fileupload-new">Select file</span><span class="fileupload-exists">Change</span><input type="file" class="margin-none" /></span><a href="#" class="btn fileupload-exists" data-dismiss="fileupload">Remove</a>
    	</span>
  	</div>
</div>
</div>
				<div class="col-md-6"><h4 class="separator bottom">File upload button</h4>
<div class="fileupload fileupload-new margin-none" data-provides="fileupload">
...
<button type="button" class="btn btn-primary" data-toggle="button">Single Toggle</button>
	...
	<div class="col-md-6">
		...
		<div class="widget">
			...
			<div class="widget-body center"><div class="btn-group" data-toggle="buttons">
...
<!-- // Widget END -->
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="btn-group btn-group-sm">
					<input type="button" id="select2_6_enable" class="btn btn-default" value="Enable"/> 
					<input type="button" id="select2_6_disable" class="btn btn-default" value="Disable"/>
				</div>
				<div class="separator bottom"></div>
				<h5>Templating</h5>
	...
	<div class="widget">
	<div class="widget-head">
		<h4 class="heading">Multiselect Example</h4>
	</div>
	<div class="widget-body">
...
<div class="widget">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header"><h3 class="modal-title">A Timepicker Inside A Modal</h3></div>
			<div class="modal-body" style="overflow: visible;">
				 <div class="bootstrap-timepicker relativeWrapp" style="vertical-align: middle;">
					 <input id="timepicker4" class="form-control" value="10:35 AM" type="text" />
				 </div>
			</div>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="widget widget-heading-simple widget-body-gray">
				...
				<div class="widget-body center"><label class="control-label">Color picker</label>
...
<div id="colorpicker"></div>
	...
	<!-- // Row END -->
		...
		<div id="footer" class="hidden-print">
			...
			<!--  Copyright Line -->
			<div class="copy">&copy; 2012 - 2014 - <a href="http://www.mosaicpro.biz">MosaicPro</a> - All Rights Reserved. <a href="http://themeforest.net/?ref=mosaicpro" target="_blank">Purchase Social Admin Template</a> - Current version: v2.0.0-rc8 / <a target="_blank" href="<?php echo base_url() ?>assets/<?php echo base_url() ?><?php echo base_url() ?>CHANGELOG.txt?v=v2.0.0-rc8">changelog</a></div>
			<!--  End Copyright Line -->
